# API Setup Guide - Pet Matchmaker

## Overview
This application uses the **Google Gemini API** to generate personalized pet adoption recommendations.

## Required API Key

### Gemini API Key
- **Service**: Google Gemini API
- **Purpose**: Generate AI-powered pet recommendations
...
### Pet Recommendation Generation
- Matches pets based on user preferences
- Considers lifestyle, family, and living situation
- Includes adoption call-to-action
- 70 words maximum per recommendation
...
- `generatePetRecommendation()` - Generates recommendations with error handling
