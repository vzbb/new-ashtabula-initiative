# PROJECT — Pocket Historian

## Desired Functionality (from CSV)
- **Pocket Historian:** Persona-based chatbot (e.g., 1890 Lighthouse Keeper) that tells stories to visitors.
...
## Assumptions
- Mapped to **Pocket Historian** CSV entry.
