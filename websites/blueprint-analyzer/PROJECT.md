# PROJECT — Blueprint Analyzer

## Desired Functionality (from CSV)
- **Blueprint Analyzer:** Drag-and-drop a PDF blueprint; AI extracts a Bill of Materials (BOM) instantly.
...
## Assumptions
- Mapped to **Blueprint Analyzer** CSV entry.
