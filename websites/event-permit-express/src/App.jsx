...
function FairgroundsLogo({ size = 50 }) {
  return (
    ...
    >
      <rect x="5" y="8" width="40" height="34" rx="6" fill="#1B4F72" stroke="#D4AC0D" strokeWidth="1.5" />
...
function ScrollReveal({ children, className = 'scroll-reveal', style }) {
  ...
  useEffect(() => {
    if (!window.IntersectionObserver) {
      if (elRef.current) elRef.current.classList.add('revealed');
      return;
    }
    ...
    <div className="app-container">
      ...
      <main className="municipal-main">
        <div className="content-container">
          ...
          {/* Hero Section — photo background + glassmorphism overlay */}
          ...
          {/* Event Configuration Card — scroll reveal */}
          <ScrollReveal className="scroll-reveal">
            <div className="municipal-card">
              <div className="municipal-card-header municipal-card-header-gold">
                <span className="municipal-card-title">
                  <span style={{ color: '#D4AC0D' }}>✦</span> Event Details
                </span>
              </div>
                    ...
                    {eventTypes.map(evt => (
                      <button
                        ...
                        style={{
                          padding: '12px',
                          borderRadius: '8px',
                          border: eventType === evt.id ? '2px solid var(--accent)' : '1px solid var(--border)',
                          background: eventType === evt.id ? '#e8f5e9' : '#fff',
                          cursor: 'pointer',
                          textAlign: 'center',
                          transition: 'all 0.2s ease'
                        }}
                        onMouseEnter={e => {
                          if (eventType !== evt.id) e.currentTarget.style.borderColor = 'var(--secondary)';
                        }}
                        onMouseLeave={e => {
                          if (eventType !== evt.id) e.currentTarget.style.borderColor = 'var(--border)';
                        }}
                      >
                        <div style={{ fontSize: '24px', marginBottom: '4px' }}>{evt.icon}</div>
                        <div style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'var(--dark-slate)' }}>{evt.label}</div>
                      </button>
                    ))}
                  </div>
                </div>
                    ...
                    {[
                      ...
                      <button
                        ...
                        style={{
                          padding: '12px',
                          borderRadius: '8px',
                          border: needs[need.key] ? '2px solid var(--secondary)' : '1px solid var(--border)',
                      ...
                      >
                        ...
                        {needs[need.key] && <span style={{ color: 'var(--secondary)', fontWeight: 600 }}>✓</span>}
                      </button>
                    ))}
                  </div>
                </div>
              ...
              {[
                ...
                <div key={feature.title} className="municipal-card" style={{ marginBottom: 0, textAlign: 'center' }}>
                  <div className="municipal-card-body">
                    ...
                    <h3 style={{ fontSize: '1rem', fontWeight: 600, color: 'var(--primary)', marginBottom: '8px' }}>
                      {feature.title}
                    </h3>
      ...
      <footer className="municipal-footer">
        <div className="footer-content">
          <div className="footer-top">
            <div className="footer-seal">
              <svg width="24" height="24" viewBox="0 0 50 50" fill="none">
                ...
                <rect x="22" y="20" width="6" height="16" fill="var(--primary)" />
                <path d="M21 20 L25 14 L29 20 Z" fill="var(--secondary)" />
              </svg>
            </div>
            <div>
          ...
          <div className="footer-address" style={{ fontSize: '0.8125rem', color: 'rgba(255,255,255,0.6)', textAlign: 'center', marginBottom: '12px' }}>127 N. Elm St, Jefferson, OH 44047</div>
          <div className="footer-bottom">
            <div className="footer-links">
              <a href="https://www.ashtabulafair.com/" className="footer-link">Fairgrounds</a>
              <a href="mailto:ashtafair@windstream.net" className="footer-link">ashtafair@windstream.net</a>
              <span className="footer-link">Brian Edelman · <a href="tel:4408586667" className="footer-link" style={{color: 'inherit'}}>440-858-6667</a></span>
            </div>
