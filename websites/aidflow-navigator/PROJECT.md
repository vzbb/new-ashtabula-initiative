# PROJECT — Aidflow Navigator

## Desired Functionality (from CSV)
- **AidFlow Navigator:** Anonymous web-based tool that quickly screens users’ eligibility for community programs (e.g., HEAP/Food Aid) to reduce call volume and admin overhead.
...
## Assumptions
- Mapped to **AidFlow Navigator** CSV entry.
