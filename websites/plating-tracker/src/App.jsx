...
function App() {
  const [po, setPo] = useState("PO‑1024");
  ...
  const check = async () => {
    ...
    setStatus("");
    try {
      const prompt = `Write a concise plating status update for ${po}. Include stage and estimated completion. 60 words max.`;
  ...
  return (
    <div className="page">
      <header className="hero">
        <div>
          <p className="eyebrow">Plating Tracker</p>
          <h1>Real‑time job updates for customers</h1>
          <p className="sub">Gemini‑powered status messaging.</p>
