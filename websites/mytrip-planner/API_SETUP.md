# API Setup Guide - MyTrip Planner

## Overview
This application uses the **Google Gemini API** to generate personalized travel itineraries for Ashtabula County.

## Required API Key

### Gemini API Key
- **Service**: Google Gemini API
- **Purpose**: Generate AI-powered trip itineraries
...
- Customizable by theme (Family, Romantic, Adventure, etc.)
- Configurable trip duration
- Includes booking call-to-actions
- 90 words maximum per itinerary
...
- `generateItinerary()` - Generates itineraries with error handling
