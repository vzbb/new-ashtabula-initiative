  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-12 lg:grid-rows-[auto_minmax(0,1fr)] gap-6 h-full">
      <div className="lg:col-span-4 lg:row-start-1 flex flex-col gap-6">
        <div>
          <h2 className="text-2xl font-bold text-stone-900 tracking-tight">Site Ops Pro</h2>
          <p className="text-stone-500 mt-1 text-sm">Advanced Heavy Civil Estimation for Severino & Koski Projects.</p>
          <p className="text-xs font-semibold text-amber-700 bg-amber-50 inline-block px-2 py-1 rounded mt-2 border border-amber-200">Partner Tool: Severino Construction & Koski Construction</p>
        </div>
