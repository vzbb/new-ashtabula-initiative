...
const buildFallbackConfirmation = (length, boatType) => {
  const slipType = boatType === "yacht" ? "premium deep-water" : "seasonal harbor";
  return `Harbor Yacht Club & Marina has added your ${length}ft ${boatType} to the ${slipType} slip waitlist. Expect seasonal dock updates within 5-7 business days. Current planning includes shore power, water access, and club communications. A marina coordinator can review fit, timing, and membership options at 440-992-2628.`;
};
  ...
  const generateConfirmation = async () => {
    ...
    try {
      if (!import.meta.env.VITE_GEMINI_API_KEY) {
        setSummary(buildFallbackConfirmation(length, boatType));
        return;
      }

      const prompt = `Write a professional marina slip waitlist confirmation for a ${length}ft ${boatType} at Harbor Yacht Club & Marina in Ashtabula, Ohio. Mention direct Lake Erie access, seasonal dock planning, shore power and water service, and a coordinator follow-up for fit and membership options. Keep it under 85 words and make it sound like a polished marina operations message.`;
        ...
        <header className="header">
          <div className="brand">
            ...
            <div className="brand-text">
              <span className="brand-name">Harbor Yacht Club & Marina</span>
              <span className="brand-tagline">Seasonal Dockage on Ashtabula Harbor</span>
            </div>
          </div>
        </header>
        ...
        <main className="main-content">
          <section className="hero-card">
            <div className="hero-content">
              ...
              <h1>Reserve a Better Place in Line for Harbor Season</h1>
              <p className="sub">A Harbor Yacht Club & Marina intake flow for seasonal dockage, member-fit planning, and Lake Erie-ready communication.</p>
              <div className="service-strip">
                <span>1833 Giannelli Avenue</span>
                <span>Direct Lake Erie access</span>
                <span>440-992-2628</span>
              </div>
              
              <div className="trust">
                <span className="trust-item"><AnchorIcon /> Seasonal dock planning</span>
                <span className="trust-item"><BoatIcon /> Boat-size fit review</span>
                <span className="trust-item"><StarIcon /> Club-ready follow-up</span>
              </div>
            </div>
            ...
            <div className="input-card">
              ...
              <button 
                ...
                disabled={loading}
              >
                {loading ? "Building Harbor Summary..." : "Request Slip Review"}
              </button>
            </div>
          </section>
          ...
          <section className="result-card">
            ...
            {summary ? (
              ...
              <div className="empty-state">
                ...
                <p>Enter your boat details to generate a Harbor Yacht Club & Marina waitlist summary with slip-fit and follow-up guidance.</p>
              </div>
            )}
          </section>
          ...
          <section className="features">
            <div className="feature">
              ...
              <h3>Harbor Fit Review</h3>
              <p>Slip planning is framed around boat length, vessel type, and seasonal availability before staff follow-up.</p>
            </div>
            <div className="feature">
              <div className="feature-icon">🔌</div>
              <h3>Dockside Amenities</h3>
              <p>Position the marina around shore power, water access, and the polished member-facing experience boaters expect.</p>
            </div>
            <div className="feature">
              <div className="feature-icon">📋</div>
              <h3>Coordinator Handoff</h3>
              <p>Each inquiry ends with a marina-ready summary that feels like a real operations handoff, not a dead-end form.</p>
            </div>
          </section>

          <section className="ops-note">
            <h3>Built for private-club dockage conversations</h3>
            <p>This demo is framed for Harbor Yacht Club & Marina: seasonal openings, member-style communication, and a cleaner handoff from web inquiry to marina coordinator.</p>
          </section>
        </main>

        <footer className="footer">
          <p>Harbor Yacht Club & Marina • Ashtabula, Ohio</p>
          <p className="footer-meta">Slip waitlist and dockage intake for Lake Erie boaters</p>
        </footer>
      </div>
    </div>
  );
