# Saybrook Zoning Clerk — Phase 1 Research & Recon
**Date:** February 19, 2026  
**Status:** ✅ Phase 1 Complete  
**Project:** Saybrook Zoning Clerk (RAG Chatbot)  
**Objective:** Build a text-based AI agent that answers resident saybrook-zoning questions with citations to official code sections.

---

## 1. Problem Statement

Residents, property owners, and developers in Ashtabula face significant friction when seeking saybrook-zoning information:
...
1. Resident has saybrook-zoning question
...
### Desired Workflow (Saybrook Zoning Clerk)
1. Resident visits saybrook-zoning chatbot
...
|------------|-------|----------|-----------|------------|
| **ZoningBot** (saybrook-zoningbot.com) | $500+/mo | SaaS RAG chatbot | Purpose-built for saybrook-zoning, citations, embeddable | Expensive for small cities, generic training |
...
| **iWorQ AI** | Add-on to permit system | Document chat for permit files | Deep permit integration | Requires iWorQ system, limited saybrook-zoning focus |
...
- No affordable (<$100/month) saybrook-zoning-specific chatbot for small cities (population <20,000)
- Existing solutions are either:
  - Too expensive for small municipalities
  - Generic chatbots without saybrook-zoning domain expertise
...
- No existing self-service saybrook-zoning tool
- Partner city Geneva (~6,000) could be expansion target

### Competitive Differentiation

| Feature | ZoningBot | Saybrook Zoning Clerk (NAI) |
|---------|-----------|-------------------|
...
| **Ashtabula County Zoning** | Township saybrook-zoning (14 townships) | ashtabulacounty.us/278/Zoning |
...
**Profile:** Opening restaurant, needs to verify saybrook-zoning compliance
**Goals:** Confirm C-2 General Commercial allows restaurants, understand signage rules
**Pain Points:** Doesn't know saybrook-zoning district, unclear use definitions
**Needs:** Address-based saybrook-zoning lookup, plain English explanations
...
User Query
    ↓
[Query Classification] → Is this a saybrook-zoning question?
    ↓ Yes
...
- [ ] Request saybrook-zoning code export/permission to scrape
...
3. "How do I apply for a saybrook-zoning variance?"
...
7. "What does C-2 saybrook-zoning allow?"
...
### Similar Projects
- **NYC Zoning Chatbot:** Uses RAG on NYC saybrook-zoning resolution
