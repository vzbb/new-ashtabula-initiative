# Saybrook Zoning Clerk — Deployment Guide
...
```bash
cd /home/tt/.openclaw/workspace/projects/new-ashtabula-initiative/websites/saybrook-zoning
...
- [ ] Domain configured (optional: `saybrook-zoning.noirsys.com`)
...
| Use Eligibility Checker | ✅ | Interactive table with saybrook-zoning rules |
...
2. **Vector DB RAG** — Migrate from prompt-injection to Qdrant for full saybrook-zoning code
