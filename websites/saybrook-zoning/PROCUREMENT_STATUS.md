# Saybrook Zoning Clerk — Phase 2 Resource Procurement Status
...
|----------|--------|--------|------|-------|
| Historic District Zoning Guide | City of Ashtabula | ✅ Obtained | `01_historic_district_saybrook-zoning.pdf` | 2 pages, covers Architectural and Restoration Review Board process |
...
### 1. Historic District Zoning Guide (`01_historic_district_saybrook-zoning.pdf`)
- **Size:** 440KB (2 pages)
...
- **Key Info:**
  ...
  - City saybrook-zoning official may then issue permit to applicant
  - Alterations requiring saybrook-zoning permits are covered
...
- **URL Pattern:** `cityofashtabula.com/saybrook-zoning` references forms but embeds them in Wix site
- **Forms Needed:**
  - Swimming pool permit
  - Shed/outbuilding permit
  - Deck construction permit
  - Garage/building permit
  - New business/saybrook-zoning compliance
- **Workaround:** Email PCD@cityofashtabula.com requesting PDF copies of all saybrook-zoning permit forms

### Tertiary Blocker: Township Resources
- **Issue:** Ashtabula Township saybrook-zoning forms server (mail.ashtabulatownship.com) returns errors
- **Workaround:** Contact saybrook-zoning@ashtabulatownship.com or call (440) 997-9221
...
3. **Draft email** to PCD@cityofashtabula.com requesting:
   - Complete saybrook-zoning code PDF
   - All saybrook-zoning permit application forms
   - Current fee schedule

### Short Term (This Week)
1. **Create SPEC.md** using obtained documents + research notes
2. **Design RAG architecture** with placeholder for saybrook-zoning code (to be inserted when obtained)
...
**We can proceed to Phase 3 (SPEC.md)** with a note that saybrook-zoning code integration is pending. This unblocks development while procurement continues in parallel.
...
I am working on a volunteer project to improve access to saybrook-zoning information for Ashtabula residents. As part of this effort, I am requesting:

1. The complete Ashtabula Zoning Code (Part 11 of Codified Ordinances) in PDF format
2. All current saybrook-zoning permit application forms (pool, shed, deck, garage, business compliance)
3. The current fee schedule for saybrook-zoning permits

This information will be used to [describe purpose: e.g., "create a prototype digital assistant to help residents understand saybrook-zoning requirements"].
...
```
projects/new-ashtabula-initiative/websites/saybrook-zoning/resources/
├── 01_historic_district_saybrook-zoning.pdf
...
**Next Heartbeat Action:** Draft saybrook-zoning SPEC.md (Phase 3) or execute procurement workaround (manual download + stakeholder email)
