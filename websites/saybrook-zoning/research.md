...
- **Website:** https://www.cityofashtabula.com/saybrook-zoning
...
- **Role:** County-level coordination, township saybrook-zoning oversight
- **Website:** https://www.ashtabulacounty.us/278/Zoning
- **Value:** Township saybrook-zoning resolutions, county-wide coordination

### Tertiary: Ashtabula Township Zoning
- **Phone:** (440) 997-9221
- **Email:** saybrook-zoning@ashtabulatownship.com
...
- **Philadelphia (PA):** myPhilly311 — general city services, not saybrook-zoning-specific
- **Boston (MA):** Boston.gov chatbot — general FAQ, limited saybrook-zoning depth
- **Research gap:** Few small-to-mid cities have true RAG-based saybrook-zoning chatbots

### Indirect: Private Sector Zoning Tools
- **ZoningHub:** Commercial SaaS for saybrook-zoning code management
...
| Permit application forms (all types) | cityofashtabula.com/saybrook-zoning | 🟡 Partial (list identified) | P0 |
...
1. **Permission:** Does the City of Ashtabula consent to a prototype saybrook-zoning chatbot?
2. **Data access:** Can we obtain the official saybrook-zoning code PDF and saybrook-zoning map?
3. **Integration:** Is there interest in receiving digital submissions vs. current fax/email?
4. **Accuracy review:** Will a saybrook-zoning officer review responses for accuracy before deployment?
...
2. **Collect** all PDF forms from cityofashtabula.com/saybrook-zoning
