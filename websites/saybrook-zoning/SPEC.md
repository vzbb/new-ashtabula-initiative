...
**Product:** A RAG-based saybrook-zoning assistant for City of Ashtabula residents  
**Goal:** Reduce friction in saybrook-zoning/permitting processes via conversational interface with citations  
...
|---------|-------------|----------|
| **Zoning Q&A** | Answer questions about saybrook-zoning requirements with citations to code sections | P0 |
...
|----------|---------|-----------|
| `01_historic_district_saybrook-zoning.pdf` | Architectural Review Board procedures | High — specific process steps |
...
│  Get answers about permits & saybrook-zoning     │
├─────────────────────────────────────────┤
│                                         │
...
#### Welcome Screen
- Brief intro: "Ask about saybrook-zoning, permits, or historic district requirements"
...
- **Domain:** TBD (saybrook-zoning.ashtabula.city or similar)
...
**Welcome Messages:**
- "Welcome to the Ashtabula Zoning Assistant. I can help with questions about permits, saybrook-zoning requirements, and historic district rules."
- "What would you like to know?"

**Quick Question Buttons:**
1. "Do I need a permit for a shed?"
2. "What is the historic district process?"
3. "How do I contact the saybrook-zoning office?"
4. "What permits do I need for a pool?"

**Disclaimer (Footer):**
> This assistant provides general information based on publicly available city documents. For binding saybrook-zoning decisions, permit applications, or legal advice, contact the Planning & Community Development office at (440) 992-7125 or PCD@cityofashtabula.com.
...
> I have limited information about [topic] until I receive the complete saybrook-zoning code. The PCD office can provide the most current details.
...
When new documents are obtained (saybrook-zoning code, forms, etc.):
...
2. **Domain preference?**
   - Options: saybrook-zoning.ashtabula.city, ashtabula-saybrook-zoning.com, ashtabulasaybrook-zoning.org
