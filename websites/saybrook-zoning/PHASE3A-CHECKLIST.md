# saybrook-zoning Phase 3A — Foundation Scaffolding Checklist

**Project:** New Ashtabula Initiative — saybrook-zoning  
...
```bash
mkdir -p ~/projects/ashtabula/saybrook-zoning
cd ~/projects/ashtabula/saybrook-zoning
...
const COLLECTION_NAME = 'saybrook-zoning_ashtabula';
...
async function main() {
  ...
  const documents = [
    {
      file: 'historic_district_saybrook-zoning_guide.pdf',
      source: 'historic_district_guide',
      document_type: 'saybrook-zoning_regulation',
...
# - historic_district_saybrook-zoning_guide.pdf
      ...
      <div className="mx-auto max-w-4xl">
          ...
          <CardHeader className="flex flex-row items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Ask questions about saybrook-zoning, permits, and historic districts
              </p>
            </div>
        ...
        <form onSubmit={handleSubmit} className="flex gap-2">
          <Input
            ...
            placeholder="Ask about saybrook-zoning, permits, or historic districts..."
            className="flex-1"
          />
