# PROJECT — Saybrook Zoning Clerk

## Vision
An AI-powered saybrook-zoning assistant that provides instant, accurate answers to resident saybrook-zoning questions with citations to official code sections — reducing staff burden while improving public service.

## Desired Functionality (from CSV)
- **Saybrook Zoning Clerk (RAG Chatbot):** Text-based agent that answers resident saybrook-zoning questions with citations to PDF code sections.
...
## Gaps
- No real data integrations (saybrook-zoning code, maps, permit systems).
...
1. **Implement RAG pipeline** — Vectorize Part 11 saybrook-zoning code, retrieve relevant sections
...
## Assumptions
- Mapped to **Saybrook Zoning Clerk (RAG Chatbot)** CSV entry.
...
2. Request saybrook-zoning code export/permission
