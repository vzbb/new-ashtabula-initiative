# Saybrook Zoning Clerk — Phase 4 Build Implementation Plan
...
- [ ] **1.2 PDF text extraction**
  ...
  - Extract from 3 obtained PDFs:
    - `01_historic_district_saybrook-zoning.pdf` → ~20 pages
...
- [ ] **1.4 Embedding + Qdrant upload**
  ...
  - Collection name: `saybrook-zoning-v1`
  - Vector size: 1536
...
**Goal:** Backend endpoint that answers saybrook-zoning questions with citations
...
- [ ] **2.5 Local testing**
  - Test queries:
    ...
    - "What is the saybrook-zoning code for fences?" (should trigger fallback without Part 11)
...
**Goal:** React component for conversational saybrook-zoning Q&A
...
- [ ] "What is R-3 saybrook-zoning?" → Low confidence → fallback
...
- [ ] Deploy to live URL: `saybrook-zoning.noirsys.com` or similar
