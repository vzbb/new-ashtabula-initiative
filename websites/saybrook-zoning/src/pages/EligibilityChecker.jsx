      ...
      <div className="bg-white p-10 rounded-3xl border border-slate-200 shadow-xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-10">
          <div>
            ...
            <p className="text-slate-500 mt-2">Determine if your planned activity or structure is allowed in your saybrook-zoning district.</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { 
            ...
            bg: 'bg-emerald-50',
            desc: 'Allowed by right, subject to standard regulations and saybrook-zoning permit approval.' 
          },
          { 
          ...
          { 
            ...
            color: 'text-rose-500', 
            bg: 'bg-rose-50',
            desc: 'Not allowed within this saybrook-zoning district under current city ordinances.' 
          },
        ].map((info, i) => (
