        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-10">
            <div>
              ...
              <p className="text-slate-500 max-w-lg">Access and download all official saybrook-zoning documents, applications, and design guidelines for the City of Ashtabula.</p>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                "Verify saybrook-zoning district on GIS map",
