...
- **Engineer’s Assistant:** Technical bot that recommends specific rubber compounds based on user temperature/pressure specs.
...
## Assumptions
- Mapped to **Engineer’s Assistant** CSV entry.
