...
function UrgencyBanner() {
  return (
    <div className="urgency-banner" style={{
      ...
      <strong>City Pilot Preview</strong>
      <span style={{ margin: '0 12px', opacity: 0.6 }}>|</span>
      <span style={{ fontWeight: 500 }}>Permit guidance demo for City of Ashtabula workflows</span>
      <span style={{ margin: '0 12px', opacity: 0.6 }}>|</span>
      <span style={{
        background: '#1e3a5f',
        color: '#d4af37',
...
function ClaimButton({ onClick }) {
  ...
  return (
    ...
    >
      <span>✨</span>
      <span>Request A Pilot Review</span>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '0.75rem', color: '#64748b' }}>Pilot onboarding and rollout support</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '0.75rem', color: '#64748b' }}>Comparable municipalities are piloting similar tools</div>
        </div>
      </div>
    </div>
  );
...
function GoLiveCountdown() {
  return (
    <div style={{
      ...
      <div style={{ fontSize: '1rem', opacity: 0.9 }}>From pilot approval to staff-ready preview</div>
      <div style={{ marginTop: '12px', fontSize: '0.8125rem', opacity: 0.8 }}>
        Minimal setup. Clear handoff. City-friendly rollout.
      </div>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div>
        <div style={{ fontWeight: 700, color: '#c0392b', marginBottom: '4px' }}>
          Reduce permit confusion before it reaches staff inboxes
        </div>
        <div style={{ fontSize: '0.875rem', color: '#64748b' }}>
          Residents often need both zoning and building guidance. This demo shows how the City of Ashtabula can explain that path clearly from the first question.
        </div>
      </div>
    </div>
  );
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ margin: 0, fontSize: '1.5rem' }}>✨ Request A Permit Assistant Review</h2>
          <p style={{ margin: '8px 0 0 0', opacity: 0.9 }}>City of Ashtabula pilot configuration</p>
        </div>
        ...
        <div style={{ padding: '24px' }}>
          <div style={{
            ...
            <div style={{ fontWeight: 600, marginBottom: '8px' }}>📞 Pilot review contact:</div>
            ...
            <div style={{
              ...
              City setup review and implementation planning
            </div>
          </div>
          
          <p style={{ color: '#64748b', fontSize: '0.875rem' }}>
            Use this review to confirm local forms, zoning touchpoints, and rollout requirements before a public launch.
          </p>
          ...
          <div style={{ marginTop: '16px', padding: '12px', background: '#e8f4f8', borderRadius: '6px' }}>
            <div style={{ fontSize: '0.8125rem', color: '#1e3a5f' }}>
              ...
              <ol style={{ margin: '8px 0 0 0', paddingLeft: '20px' }}>
                <li>Schedule a 15-minute permit workflow review</li>
                <li>Confirm City zoning inputs and County handoff details</li>
                <li>Finalize resident-facing language and fallback guidance</li>
                <li>Prepare a staff-ready pilot rollout</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <a href="mailto:michael@noirsys.com?subject=Permit Whisperer Pilot Review - City of Ashtabula" style={{
            padding: '10px 20px',
            background: '#1e3a5f',
            color: 'white',
            borderRadius: '6px',
    ...
    <div className="app-container">
      ...
      <div className="official-banner" style={{ background: '#1e3a5f', color: 'white' }}>
        <div className="official-banner-content">
          ...
          <span>City of Ashtabula Permit Guidance Demo</span>
          <span className="official-banner-seal">★</span>
        </div>
      </div>
        ...
        <div className="content-container">
          ...
          <section className="hero-section">
            ...
            <p className="hero-subtitle">
              Help residents understand when they need a zoning permit from the City,
              when they also need a County building permit, and what to prepare before they apply.
              Built for Bridge Street, Lake Avenue, West 52nd, and the rest of Ashtabula.
            </p>
          ...
          {!hasApiKey && (
            <div className="alert alert-warning">
                ...
                This preview uses a demo fallback when the AI key is missing, so staff can still review the resident guidance experience.
                </p>
              </div>
          )}
          ...
          <div style={{
            ...
            {[
              {
                title: 'Step 1: City Zoning Review',
                desc: 'Sheds, fences, decks, garages, pools, and premise changes often start with Planning & Community Development.'
              },
              {
                title: 'Step 2: County Building Permit',
                desc: 'Structural work, demolition, and inspected projects continue into the Ashtabula County Building Department and CitizenServe.'
              },
              {
                title: 'What Residents Need',
                desc: 'Permit order, likely documents, review timing, and the right contact before they make a trip or submit the wrong form.'
              },
            ].map((step) => (
              <div key={step.title} className="municipal-card" style={{ marginBottom: 0 }}>
                <div className="municipal-card-body">
                  <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#1e3a5f', marginBottom: '8px' }}>
                    {step.title}
                  </h3>
                  <p style={{ fontSize: '0.875rem', color: '#64748b', margin: 0 }}>
                    {step.desc}
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '1.75rem', color: '#2c3e50', marginBottom: '12px' }}>
              Ready to Review A City Of Ashtabula Pilot?
            </h2>
            <p style={{ color: '#64748b', marginBottom: '24px', maxWidth: '500px', marginLeft: 'auto', marginRight: 'auto' }}>
              Use this prototype to align zoning guidance, County handoff language, and resident-facing answers before a public rollout.
            </p>
      ...
      <footer className="municipal-footer" style={{ background: '#1e3a5f', color: 'white', marginTop: '40px' }}>
        <div className="footer-content" style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
          ...
          <div style={{ textAlign: 'center', borderTop: '1px solid rgba(212,175,55,0.3)', paddingTop: '20px' }}>
            ...
            <div style={{ fontSize: '0.875rem', opacity: 0.8 }}>Permit guidance demo for zoning-first resident support</div>
            <div style={{ marginTop: '16px', fontSize: '0.75rem', opacity: 0.6 }}>
              © 2026 City of Ashtabula permit demo configuration.
              <br />Built for Ohio municipal workflows
            </div>
          </div>
        </div>
      </footer>
