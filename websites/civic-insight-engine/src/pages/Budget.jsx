  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-20">
      <div className="text-center">
        <h1 className="text-4xl font-black text-gray-900 tracking-tight">County Budget Explorer</h1>
        <p className="text-slate-500 font-medium mt-2">Real-time transparency for Ashtabula County tax dollars.</p>
      </div>
      ...
      <div className="bg-slate-900 rounded-[2rem] p-10 lg:p-16 text-white shadow-2xl relative overflow-hidden">
        ...
        <div className="max-w-3xl relative z-10">
           ...
           <p className="text-slate-400 text-lg mb-12 leading-relaxed">
             Transparency means knowing exactly how your contribution supports the county. Here is the breakdown of every dollar collected in Ashtabula County.
           </p>
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-8">
              ...
              <div className="space-y-4 group">
                 ...
                 <p className="text-[10px] text-slate-400 leading-tight">County office operations, legal, and clerk's office.</p>
              </div>
              <div className="space-y-4 group">
