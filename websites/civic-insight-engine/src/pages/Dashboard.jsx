...
export default function Dashboard() {
  const countyLogoSrc = `${import.meta.env.BASE_URL}county-logo.png`;
    ...
    <div className="space-y-8 max-w-6xl mx-auto relative">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#003f87]/60 backdrop-blur-sm animate-in fade-in duration-300">
           <div className="bg-white rounded-3xl shadow-2xl max-w-xl w-full overflow-hidden animate-in zoom-in-95 duration-300">
              <div className="bg-[#003f87] p-8 text-white relative">
                 ...
                 <h2 className="text-3xl font-black tracking-tight mb-2">Welcome to Ashtabula County Government's Transparency Portal.</h2>
                 <p className="text-blue-100 font-medium">Your official access point for meetings, budgets, public records, and community engagement.</p>
              </div>
              <div className="p-8 space-y-6">
                   <p className="text-slate-600 leading-relaxed">
                   Your County Government, Working For You. This official portal provides transparency and access to county records, services, and public participation across Ashtabula County.
                 </p>
                 <div className="inline-flex rounded-full border border-[#003f87]/10 bg-[#003f87]/5 px-4 py-2 text-[10px] font-black uppercase tracking-[0.24em] text-[#003f87]">
                   Your County. Your Data. Your Voice.
                 </div>
      ...
      <section className="bg-gradient-to-br from-[#1e3a5f] to-[#152a45] rounded-3xl p-10 lg:p-16 shadow-xl text-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="mx-auto mb-8 inline-flex rounded-3xl border border-white/15 bg-white/10 px-5 py-4 shadow-lg backdrop-blur-sm">
            <img
              src={countyLogoSrc}
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full border border-white/20 mb-6">
            <span className="text-sm font-semibold text-[#d4af37]">Official County Service</span>
          </div>
          
          <h1 className="text-4xl lg:text-5xl font-black mb-4 tracking-tight" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
            Welcome to Ashtabula County Government's
            <br />Transparency Portal
          </h1>
          <p className="text-sm font-black uppercase tracking-[0.28em] text-[#d4af37]">
            Your County. Your Data. Your Voice.
          </p>
          <p className="text-lg text-white/80 max-w-2xl mx-auto leading-relaxed">
            AI-powered transparency for county budgets, meetings, records, and civic engagement
          </p>
          <p className="text-sm text-[#d4af37] mt-2 font-medium">
            Serving Ashtabula County residents since 1807 — transparent, searchable, and public by design
          </p>

          <div className="mt-8 grid gap-3 text-left md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-sm">
              <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#d4af37]">Board Summaries</p>
              <p className="mt-2 text-sm text-white/80">Turn dense commissioner and committee minutes into plain-language public updates.</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-sm">
              <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#d4af37]">Budget Visibility</p>
              <p className="mt-2 text-sm text-white/80">Make spending, funds, and road-and-bridge priorities visible without a records request.</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-sm">
              <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#d4af37]">Resident Voice</p>
              <p className="mt-2 text-sm text-white/80">Give residents a faster lane to report issues and follow county response status.</p>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Official County Board Records</p>
            </div>
