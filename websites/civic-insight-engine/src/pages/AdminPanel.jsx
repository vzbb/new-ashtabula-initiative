      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          if (isMedia) {
             ...
             extractedText = `[0:00:00] CHAIR VANCE: I'll call this regular meeting of the Ashtabula County Commissioners to order. Roll call please.
[0:00:15] CLERK: Vance, present. Hall, present. Davis, present. 
[0:01:30] COMMISSIONER HALL: I'd like to move that we accept the bids for the 2026 paving project. Northeast Ohio Paving came in at the lowest bid of 1.2 million.
[0:02:45] COMMISSIONER DAVIS: I'll second that. But I want to make sure they're starting on the north end of Lake Road first.
...
Meeting adjourned at 7:45 p.m.`;
            ...
            extractedText = `ASHTABULA COUNTY FINANCE COMMITTEE REPORT
Monday, February 2, 2026

Meeting started at 5:00 p.m. in the County Administration Building.
...
Adjourned at 6:00 p.m.`;
            ...
            extractedText = `REGULAR MEETING OF THE ASHTABULA COUNTY COMMISSIONERS
Monday, February 16, 2026

The Board of Commissioners of Ashtabula County met in regular session at 7:00 p.m. at the County Administration Building. 

Infrastructure:
The Board discussed the bids received for the 2026 Road Resurfacing Project. After review, Commissioner A moved to award the contract to Ohio Paving & Construction for $185,000. Seconded by Commissioner B. Motion carried.

Parks & Recreation:
Commissioner C presented a plan for new playground equipment at Saybrook Park. The estimated cost is $45,000. It was decided to seek community feedback before final approval.
...
Meeting adjourned at 8:30 p.m.`;
  ...
  const handleSummarize = async () => {
    ...
    try {
      ...
      addLog('Checking district boundaries and Ashtabula County Clerk protocols...');
      await new Promise(r => setTimeout(r, 800));

      // Step 5: Synthesizing Press Release
      setProcessingStep('Synthesizing Professional Press Release...');
      addLog('Applying "County Transparency" tone weights to narrative generation...');
  ...
  const loadSample = () => {
    const sample = `ASHTABULA COUNTY COMMISSIONERS MEETING MINUTES
February 26, 2026

The meeting was called to order at 7:00 PM by Commissioner John Smith.
All members present.

Old Business:
1. Paving Program 2026: Commissioners discussed the bids for the summer paving program. Commissioner Davis recommended the contract be awarded to Northeast Ohio Paving Inc. for $1.2M.
...
2. Emergency Services Grant: Chief Thompson reported the department received a $50k federal grant for new safety equipment. The Board voted to accept the funds.
  ...
  if (!user.isAdmin) {
    return (
      <div className="max-w-md mx-auto py-20 text-center">
        ...
        <p className="text-gray-600 mb-8">This area is restricted to county clerks and authorized officials.</p>
        <button 
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-20 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">County Clerk Control Center</h1>
          <p className="text-gray-500 font-medium">Manage county meeting summaries and community issues.</p>
        </div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="bg-white p-10 rounded-2xl border-4 border-double border-slate-100 shadow-inner text-sm text-slate-800 leading-relaxed max-h-[400px] overflow-y-auto whitespace-pre-wrap font-serif relative">
                           ...
                           <div className="text-center mb-8 border-b-2 border-slate-900 pb-6 relative z-10">
                              ...
                              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1">Ashtabula County Government • Office of the County Clerk</p>
                           </div>
                ...
                summaries.map(s => (
                  <div key={s.id} className="p-6 flex items-center justify-between hover:bg-slate-50 transition">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          <div className="font-bold text-gray-900 leading-tight">County Board Meeting</div>
                         ...
                         <div key={comment.id} className="flex gap-4">
                            ...
                            <div className="flex-grow bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
                               <div className="flex justify-between items-center mb-1">
                                  <span className="text-xs font-black text-blue-600 uppercase tracking-widest">County Admin</span>
