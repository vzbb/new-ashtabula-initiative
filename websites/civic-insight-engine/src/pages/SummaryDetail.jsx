    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-slate-900 px-8 py-10 text-white">
          ...
          <h1 className="text-4xl font-extrabold leading-tight">County Board of Commissioners Meeting</h1>
        ...
        <div className="bg-slate-50 px-12 py-6 border-t border-slate-100 text-center">
          <p className="text-xs text-slate-400 font-medium">
            This summary was generated by the Civic Insight Engine AI and reviewed by the County Clerk. 
