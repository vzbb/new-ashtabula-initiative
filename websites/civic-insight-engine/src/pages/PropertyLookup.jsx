  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="text-center">
        ...
        <p className="text-gray-600">Access Ashtabula County auditor data and county permit records in one place.</p>
      </div>
      ...
      {!result && !isSearching && (
        <div className="grid md:grid-cols-3 gap-6 opacity-60">
           ...
           <div className="p-4 border border-dashed border-gray-300 rounded-xl text-center">
              <div className="text-xs font-bold text-gray-400 mb-1">ASHTABULA COUNTY</div>
