# PROJECT — License Wizard

## Desired Functionality (UNVERIFIED — inferred from app name)
- Wizard to help users determine required licenses/permits.
...
## Assumptions
- UNVERIFIED: No matching CSV entry found; scope inferred from app name.
