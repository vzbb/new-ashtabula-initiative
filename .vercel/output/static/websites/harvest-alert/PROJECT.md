# PROJECT — Harvest Alert

## Desired Functionality (from CSV)
- **Harvest Alert Agent:** Email/text list that auto-notifies customers when specific crops are ready based on weather data.
...
## Assumptions
- Mapped to **Harvest Alert Agent** CSV entry.
