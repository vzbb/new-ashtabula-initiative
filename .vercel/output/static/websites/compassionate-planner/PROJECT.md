# PROJECT — Compassionate Planner

## Desired Functionality (from CSV)
- **Compassionate Planning Assistant:** A gentle, secure web guide for pre-planning funeral services at a family’s own pace.
...
## Assumptions
- Mapped to **Compassionate Planning Assistant** CSV entry.
