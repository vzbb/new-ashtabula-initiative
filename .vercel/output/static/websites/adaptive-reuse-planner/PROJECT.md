# PROJECT — Adaptive Reuse Planner

## Desired Functionality (from CSV)
- **Adaptive Reuse Planner:** Upload a photo of a vacant building; AI lists permitted uses and setbacks based on the new code.
...
## Assumptions
- Mapped to **Adaptive Reuse Planner** CSV entry.
