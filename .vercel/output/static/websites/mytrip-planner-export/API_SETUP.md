# API Setup Guide - MyTrip Planner Export

## Overview
This application uses the **Google Gemini API** to generate export-ready travel itineraries for Ashtabula County.
...
- Export-ready format
- 120 words maximum per itinerary
