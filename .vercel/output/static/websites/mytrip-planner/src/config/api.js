/**
 * API Configuration for MyTrip Planner
...
export async function generateItinerary(theme, days) {
  ...
  const prompt = `Create a ${days}-day Ashtabula itinerary for a ${theme} trip. Include 4-6 bullets and a booking CTA. 90 words max.`;
