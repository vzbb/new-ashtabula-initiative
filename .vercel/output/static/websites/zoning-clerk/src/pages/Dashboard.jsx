  ...
  const cards = [
    {
      ...
      description: 'Search for properties by address to find zoning districts and parcel details.',
      icon: Search,
      path: '/lookup',
    ...
    },
    {
      ...
      description: 'Ask our AI any questions about Ashtabula zoning codes and procedures.',
      icon: MessageSquare,
      path: '/chat',
    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700">
      <div className="bg-ashtabula-primary rounded-3xl p-10 text-white relative overflow-hidden shadow-2xl border border-white/10">
        <div className="relative z-10 max-w-2xl">
          ...
          <h1 className="text-5xl font-bold mb-6 leading-tight">How can we help you with zoning today?</h1>
          <p className="text-xl text-white/70 mb-8 leading-relaxed">
            Navigate through the city's official tools to find information 
            about property regulations, permits, and zoning codes.
          </p>
