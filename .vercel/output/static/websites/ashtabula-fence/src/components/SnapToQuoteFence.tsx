  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-12 lg:grid-rows-[auto_minmax(0,1fr)] gap-6 h-full">
      <div className="lg:col-span-4 lg:row-start-1 flex flex-col gap-6">
        <div>
          <h2 className="text-2xl font-bold text-emerald-900 tracking-tight">Ashtabula Fence Co. - Instant Quote</h2>
          <p className="text-emerald-600/70 mt-1 text-sm">Get a precise estimate for your next fencing project with Ashtabula Fence Co.</p>
        </div>
